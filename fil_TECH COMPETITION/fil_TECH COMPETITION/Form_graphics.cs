                ...
                if (tr_mult.Text != "" && txtBox_x.Text != "" && txtBox_zn.Text != "" && txt_degree.Text != "")
                {
                   ...
                   /* if (txt_degree.Text == "x" || txt_degree.Text == "X")
                    ...
                    for (int i = -num_dots / 2; i < num_dots / 2; i++)
                    {
                        if (Is_Sinus == 0)
                        {
                            x[i + num_dots / 2] = i * 10 + graphics.Width / 2;
                            //if (isX == false)
                            //{
                                y[i + num_dots / 2] = tr_fun_mult * Math.Round(Math.Cos(degree_mult * i * 10), 2) + i * 10 * x_mult + b;
                            /*}
                            else
                            {
                        ...
                        else if (Is_Sinus == 1)
                        {
                           ...
                           // if (isX == false)
                            //{
                                y[i + num_dots / 2] = tr_fun_mult * Math.Round(Math.Sin(degree_mult* i * 10), 2) + i * 10 * x_mult + b;
                            //}
                            /*else
                            {
                        ...
                        if(Math.Abs(i) <= 50)
                        listBox1.Items.Add("X: " + (i) + "                                         Y: " + Math.Round(y[i + num_dots / 2], 2));
                    ...
                    listBox1.Items.Add("Mult_x: " + mult_x + " Mult_y: " + mult_y);
                    */
                    draw_axis(minx * mult_x, maxx * mult_x, miny, maxy, type);
